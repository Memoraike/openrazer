...
class RazerDevice(object):
    ...
    def __init__(self, serial: str) -> None:
        ...
        self._capabilities = {
            ...
            'lighting_left_ear': self._has_feature('razer.device.lighting.left_ear'),
            'lighting_left_ear_active': self._has_feature('razer.device.lighting.left_ear', 'setLeftEarActive'),
            'lighting_left_ear_brightness': self._has_feature('razer.device.lighting.left_ear', 'setLeftEarBrightness'),
            'lighting_left_ear_spectrum': self._has_feature('razer.device.lighting.left_ear', 'setLeftEarSpectrum'),
            'lighting_left_ear_static': self._has_feature('razer.device.lighting.left_ear', 'setLeftEarStatic'),
            'lighting_left_ear_none': self._has_feature('razer.device.lighting.left_ear', 'setLeftEarNone'),
            'lighting_left_ear_reactive': self._has_feature('razer.device.lighting.left_ear', 'setLeftEarReactive'),
            'lighting_left_ear_wave': self._has_feature('razer.device.lighting.left_ear', 'setLeftEarWave'),
            'lighting_left_ear_breath_single': self._has_feature('razer.device.lighting.left_ear', 'setLeftEarBreathSingle'),
            'lighting_left_ear_breath_dual': self._has_feature('razer.device.lighting.left_ear', 'setLeftEarBreathDual'),
            'lighting_left_ear_breath_random': self._has_feature('razer.device.lighting.left_ear', 'setLeftEarBreathRandom'),
            'lighting_left_ear_breath_mono': self._has_feature('razer.device.lighting.left_ear', 'setLeftEarBreathMono'),

            'lighting_right_ear': self._has_feature('razer.device.lighting.right_ear'),
            'lighting_right_ear_active': self._has_feature('razer.device.lighting.right_ear', 'setRightEarActive'),
            'lighting_right_ear_brightness': self._has_feature('razer.device.lighting.right_ear', 'setRightEarBrightness'),
            'lighting_right_ear_spectrum': self._has_feature('razer.device.lighting.right_ear', 'setRightEarSpectrum'),
            'lighting_right_ear_static': self._has_feature('razer.device.lighting.right_ear', 'setRightEarStatic'),
            'lighting_right_ear_none': self._has_feature('razer.device.lighting.right_ear', 'setRightEarNone'),
            'lighting_right_ear_reactive': self._has_feature('razer.device.lighting.right_ear', 'setRightEarReactive'),
            'lighting_right_ear_wave': self._has_feature('razer.device.lighting.right_ear', 'setRightEarWave'),
            'lighting_right_ear_breath_single': self._has_feature('razer.device.lighting.right_ear', 'setRightEarBreathSingle'),
            'lighting_right_ear_breath_dual': self._has_feature('razer.device.lighting.right_ear', 'setRightEarBreathDual'),
            'lighting_right_ear_breath_random': self._has_feature('razer.device.lighting.right_ear', 'setRightEarBreathRandom'),
            'lighting_right_ear_breath_mono': self._has_feature('razer.device.lighting.right_ear', 'setRightEarBreathMono'),
